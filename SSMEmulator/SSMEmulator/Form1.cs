...
namespace SSMEmulator
{
    public partial class SSMEmulatorForm : Form
    {
        ...
        private void trackBar_Speed_ValueChanged(object sender, EventArgs e)
        {
            ...
            ssmcomout1.set_value(SSM_Parameter_Code.Vehicle_Speed, val);
            label_Speed.Text = val.ToString();
        }

        private void trackBar_CoolantTemp_ValueChanged(object sender, EventArgs e)
        {
            Int32 val = trackBar_CoolantTemp.Value;
            ssmcomout1.set_value(SSM_Parameter_Code.Coolant_Temperature, val);
            label_CoolantTemp.Text = val.ToString();
        }
        ...
        private void trackBar_Throttle_ValueChanged(object sender, EventArgs e)
        {
            Int32 val = trackBar_Throttle.Value;
            ssmcomout1.set_value(SSM_Parameter_Code.Throttle_Opening_Angle, val);
            label_Throttle.Text = val.ToString();
        }

        private void trackBar_AF_ValueChanged(object sender, EventArgs e)
        {
            Int32 val = trackBar_AF.Value;
            ssmcomout1.set_value(SSM_Parameter_Code.Air_Fuel_Sensor_1, val);
            label_AF.Text = val.ToString();
        }

        private void trackBar_InjPulse_ValueChanged(object sender, EventArgs e)
        {
            Int32 val = trackBar_InjPulse.Value;
            ssmcomout1.set_value(SSM_Parameter_Code.Fuel_Injection_1_Pulse_Width, val);
            label_InjPulse.Text = val.ToString();
        }

        private void checkBox_Neutral_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBox_Neutral.Checked)
            {
                ssmcomout1.set_value(SSM_Parameter_Code.Switch_P0x062, 0x80);
            }
            else
            {
                ssmcomout1.set_value(SSM_Parameter_Code.Switch_P0x062, 0x00);
            }
        }
